    ...
    public Iterator<FunctionPoint> iterator() {
        return new Iterator<>() {
            ...
            public FunctionPoint next() {
                if (!hasNext()) {
                    throw new NoSuchElementException("No more function points");
                }
                FunctionPoint copy = current.point.clone();
                current = current.next;
                return copy;
            }
            ...
            @Override
            public void remove() {
                throw new UnsupportedOperationException("Removing points via iterator is not supported");
            }
        };
    }
